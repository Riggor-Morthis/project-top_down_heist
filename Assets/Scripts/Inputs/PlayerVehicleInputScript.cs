...
public class PlayerVehicleInputScript : MonoBehaviour
{
    #region Variables
    ...
    private PlayerVehicleControlScript playerVehicleControl; //Le script pour controler le vehicule du joueur
    #endregion

    #region Awake
    private void Awake()
    {
        playerVehicleControl = GetComponent<PlayerVehicleControlScript>();
    }
    #endregion
